  ...
  <section class="logo_container" >
	 ...
	 <nav id="nav">
		...
		<li class="dropdown"> <a class="dropdown-toggle" > Gestion des Administrateurs <b class="caret"></b> </a>
   					 ...
   					 <li class="dropdown Active"> <a class="dropdown-toggle"  > GESTION DES evenement <b class="caret"></b> </a>
						<ul class="dropdown-menu">
		...
		<section class="row-fluid">
			<section id="donation_box">
				<section class="container container-fluid">
					<section class="row-fluid">
					<div class="span8 first" > <h2>modifier les evenements </h2> </div>
...
<section id="content" class="mbtm blog">
	...
	<p align="center">
							<a href="ajouter_evenement.php">Ajouter un evenement</a><br/>
							<a href="liste_evenements.php">Afficher liste evenements</a>
						</p>
						...
						<form method="post" action="valider_modifier_evenement.php?id=<?php echo $ligne['id_evenement']; ?>">
							Nom evenement: <input type="text" name="nom_evenement" value="<?php echo $ligne['nom']; ?>"><br/>
							Type evenement: <input type="text" name="type_evenement" value="<?php echo $ligne['type']; ?>"><br/>
							Lieu evenement: <input type="text" name="lieu_evenement" value="<?php echo $ligne['lieu']; ?>"><br/>
							Date evenement: <input type="date" name="date_evenement" value="<?php echo $ligne['date']; ?>"><br/>
							Description:<textarea rows="4" cols="50" name="description"><?php echo $ligne['description']; ?></textarea><br/>
