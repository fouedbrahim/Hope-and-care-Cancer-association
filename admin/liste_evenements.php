		...
		<section class="row-fluid">
			<section id="donation_box">
				<section class="container container-fluid">
					<section class="row-fluid">
					<div class="span8 first" > <h2>afficher la liste des evenements</h2> </div>
						...
						<table border="1">
							...
							<?php
								...
								while ($data=(mysql_fetch_array($resultat))){
									...
									echo "<td><a href='modifier_evenement.php?id=".$data['id_evenement']."'>Modifier </a><a href='supprimer_evenement.php?id=".$data['id_evenement']."'>Supprimer</a></td>";
								}
							?>
						</table>
