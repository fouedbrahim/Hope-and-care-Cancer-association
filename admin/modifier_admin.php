		...
		<section class="row-fluid">
			<section id="donation_box">
				<section class="container container-fluid">
					<section class="row-fluid">
					<div class="span8 first" > <h2>Modifier un administrateur  </h2> </div>
		...
		<section class="row-fluid">
				...
				<section class="span9" id="blog_listing">
					...
					<div class="inner_lyr">
						...
						<br><br>
	<form name="form" method="post" action="update_admin.php">	
	
	<div id="div_img"><br><h5>Veuiller inserer une image </h5>
	
	<img src="./photo/<?php echo $_GET['photo']?>" width="60" height="60" border="1" id="imge"/>


	<input type="file" name="image" id="image" accept="image/*" onchange="document.getElementById('imge').src='photo/'+this.value;">
	<input type="hidden" name="img" value="<?php echo $_GET['photo']?>"> 
	</div>
	
	
	<div id="div_auth">
	<table><tr> <td>Nom</td> <td><input type="text" id="nom" name="nom" value=<?php echo $_GET['nom']?>></td></tr>
	<tr> <td>Prenom</td> <td><input type="text" id="prenom" name="prenom" value=<?php echo $_GET['prenom']?>></td></tr>
	<tr> <td>sexe</td> <td>
         <?php   if ($_GET['sexe']==homme) {?>
...
{?>				
	...
	<tr> <td>Date de naissance</td> <td><input type="text" id="daten" name="daten" value=<?php echo $_GET['daten']?>></td></tr>
	<tr> <td>Adresse</td> <td><input type="text" id="adrs" name="adrs" value=<?php echo $_GET['adresse']?>></td></tr>
	<tr> <td>Téléphon</td> <td><input type="text" id="tel" name="tel" value=<?php echo $_GET['tel']?>></td></tr>
	...
	<tr><td></td><td><br><input type="button" value="modifier" id="button2" onclick="valider_mod()"><input type="reset" value="Annuler" id="button2"></td></tr></table>
