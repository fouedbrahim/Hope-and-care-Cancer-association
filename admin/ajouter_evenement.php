		...
		<section class="row-fluid">
			<section id="donation_box">
				<section class="container container-fluid">
					<section class="row-fluid">
					<div class="span8 first" > <h2> Ajouter un evenement </h2> </div>
		...
		<section class="row-fluid">
				...
				<section class="span9" id="blog_listing">
					...
					<div class="inner_lyr">
						...
						<form method="post" action="valider_ajout_evenement.php">
							Nom evenement: <input type="text" name="nom_evenement"><br/>
							Type evenement: <input type="text" name="type_evenement"><br/>
							Lieu evenement: <input type="text" name="lieu_evenement"><br/>
							Date evenement: <input type="date" name="date_evenement"><br/>
